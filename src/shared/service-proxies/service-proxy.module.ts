...
@NgModule({
    providers: [
        ApiServiceProxies.TestEntitiesServiceProxy,        
        ApiServiceProxies.FlightsServiceProxy,        
        ApiServiceProxies.TravelAgentsServiceProxy,        
        ApiServiceProxies.FlightInformationsServiceProxy,        
        ApiServiceProxies.JobTitlesServiceProxy,        
        ApiServiceProxies.PurposesServiceProxy,        
